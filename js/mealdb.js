    ...
    meals.forEach(meal => {
        ...
        <div class="card h-100">
            ...
            <div class="card-body">
                ...
                <p class="card-text text-justify">${meal.strMeal} is a ${meal.strArea} ${meal.strCategory}. Ingredients used to prapare this item is ${meal.strIngredient1}, ${meal.strIngredient2}, ${meal.strIngredient3}, ${meal.strIngredient4}, ${meal.strIngredient5}, ${meal.strIngredient6}, ${meal.strIngredient7}, ${meal.strIngredient8}, ${meal.strIngredient9}, ${meal.strIngredient10} & etc. </p>
